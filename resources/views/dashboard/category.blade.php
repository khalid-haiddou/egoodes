...
<body>
    <script src={{ asset('css/assets/static/js/initTheme.js') }}></script>
    <div id="app">
        <div id="sidebar">
...
<div class="page-content"> 
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                <td style="padding-left: 30px">{{ $category->id }}</td>
                <td style="padding-left: 100px">{{ $category->name }}</td>
                <td style="padding-left: 100px"><img src="{{ asset('images/' . $category->image) }}" alt="Category Image" width="50"></td>
                <td style="padding-left: 300px">
                <!-- Update Button -->
                <button type="button" class="btn btn-primary btn-sm btn-edit edit-category" data-id="{{ $category->id }}" data-name="{{ $category->name }}">Edit</button>
...
<footer>
    ...
    <script src={{ asset('css/assets/static/js/components/dark.js') }}></script>
    <script src={{ asset('css/assets/extensions/perfect-scrollbar/perfect-scrollbar.min.js') }}></script>
    
    
    <script src={{ asset('css/assets/compiled/js/app.js') }} ></script>
